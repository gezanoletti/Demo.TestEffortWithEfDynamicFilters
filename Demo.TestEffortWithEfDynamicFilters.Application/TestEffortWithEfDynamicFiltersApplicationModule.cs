...
{
    [DependsOn(typeof(TestEffortWithEfDynamicFiltersCoreModule), typeof(AbpAutoMapperModule))]
    public class TestEffortWithEfDynamicFiltersApplicationModule : AbpModule
    {
