...
namespace Demo.TestEffortWithEfDynamicFilters.Migrations.SeedData
{
    public class TenantRoleAndUserBuilder
    {
        ...
        public TenantRoleAndUserBuilder(TestEffortWithEfDynamicFiltersDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            if (adminRole == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new TestEffortWithEfDynamicFiltersAuthorizationProvider())
