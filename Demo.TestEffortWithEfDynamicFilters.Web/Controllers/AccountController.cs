...
using Demo.TestEffortWithEfDynamicFilters.Sessions;
using Demo.TestEffortWithEfDynamicFilters.Web.Controllers.Results;
using Demo.TestEffortWithEfDynamicFilters.Web.Models;
using Demo.TestEffortWithEfDynamicFilters.Web.Models.Account;
...
{
    public class AccountController : TestEffortWithEfDynamicFiltersControllerBase
    {
